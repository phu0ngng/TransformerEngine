...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 7:  # Need at least the 3 required distributed args
        ...
        print("Usage: python test_dense_grad.py --coordinator-address <address> --num-process <num> --process-id <id> [--local-device-ids <ids>] [other args]")
        print("Example: python test_dense_grad.py --coordinator-address localhost:1234 --num-process 4 --process-id 0")
        print("Example: python test_dense_grad.py --coordinator-address localhost:1234 --num-process 2 --process-id 0 --local-device-ids 0,1,2,3")
        sys.exit(1)
